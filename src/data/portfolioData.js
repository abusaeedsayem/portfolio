// Comprehensive Portfolio Configuration Data for Abu Saeed Mohammad Sayem
// Sourced directly from NYS Employment Application Part 1 (Form #S1000) and Official Resume.

export const personalInfo = {
  name: "Abu Saeed Mohammad Sayem",
  aliases: ["Abu Saeed Sayem", "Abu Saeed Muhammad Sayem"],
  title: "Public Service & Operations Specialist | Certified NYS 55-b Eligible Candidate",
  location: "Schenectady, NY",
  fullAddress: "1275 Gerling Street, Apt 8C3, Schenectady, NY 12308",
  county: "Schenectady County",
  email: "asaeedmsayem@gmail.com",
  phone: "(518) 707-8201",
  availability: "Certified NYS 55-b Eligible Candidate • Available within 2 weeks",
  civilServiceStatus: "Officially Certified NYS 55-b Eligible Candidate under Governor's Program to Hire Individuals with Disabilities (NYS Civil Service Law Section 55-b). Eligibility Letter issued June 10, 2026 (Expires June 10, 2029).",
  desiredPositions: "Office Assistant (All Tiers) / Clerical & Administrative Support / Program Aide / Operations Specialist (Salary Grade 06 to Grade 18)",
  desiredLocations: ["Schenectady", "Albany", "Saratoga", "Rensselaer"],
  ...
  bioShort: "Detail-oriented administrative, records management, and operations professional with extensive experience in regulated public service environments, technical QA, and high-volume data entry.",
  bioLong: [
    "I am an officially certified NYS 55-b Eligible Candidate under the Governor's Program to Hire Individuals with Disabilities (NYS Civil Service Law Section 55-b), actively seeking administrative, clerical, and operations specialist roles across NYS agencies in Schenectady, Albany, Saratoga, and Rensselaer counties.",
    "Holding an International Diploma in Computer Studies (Business System Development, NCC Education UK) and a Master of Business Administration (MBA in Finance, Asian University of Bangladesh), I bridge technical software systems, QA testing, and high-precision records management.",
    "My background spans federal mail processing & database entry at the United States Postal Service (Albany, NY), manufacturing quality control tracking at Plug Power Inc. (Latham, NY), QA web app testing at CLEER Security LLC, and digital research & content operations. I maintain 100% SOP compliance and absolute data confidentiality."
  ],
  ...
  stats: [
    ...
    { label: "Public & Tech Experience", value: "4+ Yrs" },
    { label: "Desired NYS Salary Grades", value: "SG 06 - 18" },
    { label: "Language Fluency", value: "Bilingual (4)" }
  ]
};

export const typewriterRoles = [
  "Certified NYS 55-b Candidate",
  "Public Service & Operations Specialist",
  "Records Management & Keyboarding Pro",
  "Quality Assurance & Systems Specialist",
  "AI Workflow & Data Administrator"
];

export const skillCategories = [
  { id: "all", label: "All Skills" },
  { id: "operations", label: "Operations & Records" },
  { id: "productivity", label: "Office & Google Suites" },
  { id: "qa_systems", label: "QA & Business Systems" },
  { id: "languages_ai", label: "Languages & AI Tools" }
];

export const skills = [
  // Operations & Records
  { name: "Public Service Operations", level: 98, category: "operations", icon: "ShieldCheck" },
  ...
  { name: "Data Confidentiality & Privacy Protocols", level: 99, category: "operations", icon: "Lock" },
  { name: "Document Preparation & Report Compiling", level: 95, category: "operations", icon: "Layout" },

  // Productivity
  { name: "Microsoft Excel (Test Logs, Charts, Graphs)", level: 94, category: "productivity", icon: "Table" },
  { name: "Microsoft Word & Formatting", level: 96, category: "productivity", icon: "FileText" },
  { name: "Google Workspace (Docs, Sheets, Drive)", level: 95, category: "productivity", icon: "Cloud" },
  { name: "Microsoft Outlook & Digital Calendars", level: 92, category: "productivity", icon: "Calendar" },
  ...
  { name: "AI Research & Synthesis Tools", level: 94, category: "languages_ai", icon: "Sparkles" },
  { name: "AI Text Generation & Script Editing", level: 92, category: "languages_ai", icon: "Brain" }
];

export const projectCategories = [
  { id: "all", label: "All Projects" },
  { id: "operations", label: "Operations & Records" },
  { id: "qa_systems", label: "QA & Technical Systems" },
  { id: "ai_content", label: "AI & Content Workflows" }
];

export const projects = [
  {
    id: "usps-records-operations",
    title: "High-Volume Official Records & Mail Routing Operations",
    category: "operations",
    tagline: "High-volume database data entry, time-sensitive mail routing, and document prep under federal SOPs.",
    description: "Served as PSE Mail Processing Clerk & Mail Handler Assistant at the USPS Albany facility (30 Karner Rd). Executed continuous database data entry, records keeping, document layout verification, and customer service while maintaining absolute confidentiality and federal privacy guidelines.",
    featured: true,
    imageColor: "linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%)",
    tags: ["USPS Albany", "Database Data Entry", "Records Keeping", "Federal SOPs", "Data Privacy"],
    githubUrl: "",
    ...
    architecture: [
      ...
      "Strict layout accuracy and federal compliance for official correspondence.",
      "Cross-functional support under Distribution Operations supervisors."
    ]
  },
  {
    id: "plug-power-qc-logs",
    title: "Technical Quality Control & Manufacturing Operations System",
    category: "qa_systems",
    ...
    description: "Served as Production Technician at Plug Power Inc. (Latham, NY). Monitored manufacturing workflows adhering strictly to corporate SOPs. Prepared daily logs, technical test spreadsheets, status charts, graphs, and raw material inventory tracking.",
    featured: true,
    imageColor: "linear-gradient(135deg, #059669 0%, #10b981 100%)",
    tags: ["Plug Power Inc.", "Excel Test Spreadsheets", "Quality Control", "Inventory Logs"],
    githubUrl: "",
    liveUrl: personalInfo.socialLinks.linkedin,
  ...
  },
  {
    ...
    tags: ["CLEER Security", "QA Testing", "Technical Issue Tracking", "Project Records"],
    githubUrl: "",
    liveUrl: personalInfo.socialLinks.linkedin,
...
export const experience = [
  {
    ...
    achievements: [
      ...
      "Seeking permanent NYS Civil Service appointment under the 55-b Program."
    ],
  ...
  },
  {
    ...
    technologies: ["Database Data Entry", "Records Keeping", "Public Service", "Federal SOPs", "Data Privacy"]
  },
  {
    id: "exp-2",
  ...
  },
  {
    ...
    technologies: ["QA Web Testing", "Technical Issue Logs", "Project Records", "Bug Tracking"]
  },
  {
    id: "exp-4",
    ...
    technologies: ["Quality Control", "Excel Test Spreadsheets", "SOP Compliance", "Inventory Tracking", "Status Reports"]
  },
  {
    id: "exp-5",
    role: "Certified NYS 55-b Eligible Candidate",
    company: "New York State Department of Civil Service",
    period: "Issue Date: June 10, 2026 – June 10, 2029",
    location: "New York State",
    type: "Certification",
    description: "Officially certified under the Governor's Program to Hire Individuals with Disabilities (NYS Civil Service Law Section 55-b). Qualified for non-competitive entry-level civil service appointments across NYS agencies.",
    achievements: [
      "Eligible for Office Assistant (All Tiers), Clerical & Administrative Support, Program Aide, and Operations Specialist roles (Salary Grade 06 to 18).",
      "Preferred locations: Schenectady, Albany, Saratoga, and Rensselaer counties.",
      "Official Letter of Eligibility on file."
    ],
    technologies: ["NYS Civil Service Law 55-b", "State Administrative Eligibility", "Salary Grades 06-18"]
  },
  {
    id: "exp-6",
  ...
  },
  {
    ...
    company: "Board of Intermediate and Secondary Education",
    period: "General Academic",
    location: "Rajshahi, Bangladesh",
    type: "Education",
    description: "Higher Secondary Certificate program covering general academic discipline and foundational studies.",
    achievements: [
      "Received Higher Secondary Certificate diploma."
    ],
    technologies: ["General Academic Discipline", "Foundational Science & Humanities"]
  }
];
